...
registerProcessor("rotary-sample", class extends AudioWorkletProcessor {
        ...
        private numTracks: number = 0 | 0
        private numFrames: number = 0 | 0
        private position: number = 0 | 0
        private chunkLength: number = 0 | 0
        ...
        constructor() {
            ...
            this.port.onmessage = event => {
                ...
                if (data.action === "numTracks") {
                    ...
                    this.chunkLength = Math.floor(this.numFrames / /*numChannels*/16)
                }
            }
        }
        ...
        process(inputs: Float32Array[][], outputs: Float32Array[][]): boolean {
            ...
            for (let frameIndex = 0; frameIndex < 128; frameIndex++) {
                ...
                if (++this.position >= this.chunkLength) this.position = 0 | 0
            }
            return true
        }
    }
