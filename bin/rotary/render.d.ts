...
export declare class RotaryRenderer {
    ...
    static renderFrames(model: RotaryModel, numFrames: number, size: number, subFrames: number, process: (context: CanvasRenderingContext2D) => void, progress?: (progress: number) => void): Promise<void>;
