...
import { NoArgType, NumericStepper, ObservableValue, PrintMapping, Terminable } from "../lib/common.js";
...
export declare class TypeValueEditor<T> implements Editor<ObservableValue<T>> {
