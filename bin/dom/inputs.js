...
import { ObservableValueVoid, Terminator } from "../lib/common.js";
export class Checkbox {
    constructor(element) {
        this.element = element;
        this.terminator = new Terminator();
        this.value = ObservableValueVoid.Instance;
...
export class SelectInput {
    ...
    connect() {
        ...
        this.terminator.with(Dom.bindEventListener(this.select, "change", () => this.value.set(this.values[this.select.selectedIndex])));
    }
}
export class NumericStepperInput {
    ...
    connect() {
        ...
        this.terminator.with(Dom.bindEventListener(this.input, "focusin", (focusEvent) => {
            const blur = (() => {
