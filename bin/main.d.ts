...
declare module "lib/dsp" {
    ...
    export const pulsarDelay: (context: AudioContext, input: AudioNode, output: AudioNode, delayTimeL: number, delayTimeR: number, delayTime: number, feedback: number, lpf: number, hpf: number) => void;
}
declare module "rotary/export" {
    export const exportVideo: () => Promise<void>;
}
declare module "dom/menu" {
